(() => {
  ...
  function useStorage(GRID_ROW, GRID_COL) {
    const [grid, setGrid] = (0, import_react2.useState)(localStorage.getItem("grid") ? JSON.parse(localStorage.getItem("grid")) : defaultGrid(GRID_ROW, GRID_COL));
    const [guess, setGuess] = (0, import_react2.useState)(localStorage.getItem("guess") ? JSON.parse(localStorage.getItem("guess")) : defaultGuess(GRID_ROW));
  ...
  var Crossword = ({
    ...
    const [direction, setDirection] = import_react4.default.useState("row");
    const [editMode, setEditMode] = import_react4.default.useState(false);
    const [active, setActive] = import_react4.default.useState({ col: 0, row: 0 });
    const { grid, guess, setGrid, setGuess, reset: resetData } = useStorage(GRID_ROW, GRID_COL);
    const cols = import_react4.default.useMemo(() => new Array(GRID_COL).fill(""), [GRID_COL]);
    function handleClick(row, col) {
      if (editMode) {
        const newState = import_lodash.default.cloneDeep(grid);
    ...
    function moveActive(row, col, step = 1) {
      if (!import_lodash.default.isNaN(active.row) && !import_lodash.default.isNaN(active.col)) {
    ...
    function handleKeyDown(e) {
      ...
      if (!import_lodash.default.isNil(active.row) && !import_lodash.default.isNil(active.col) && !e.ctrlKey && !editMode) {
        if (e.keyCode >= 65 && e.keyCode <= 90) {
          const newState = import_lodash.default.cloneDeep(guess);
    ...
    }), cols.map((c, j) => /* @__PURE__ */ import_react4.default.createElement("div", {
      className: "cw_col-head",
      style: { flex: 100 / GRID_COL },
      key: j
    }, j + 1))), grid.map((row, i) => /* @__PURE__ */ import_react4.default.createElement(Row_default, {
      key: i,
      value: i,
      cellSize
    }, row.map((cell, j) => /* @__PURE__ */ import_react4.default.createElement(Cell_default, {
      key: `${i}-${j}`,
      cell,
      size: cellSize,
    ...
    }, import_lodash.default.get(guess, `[${i}][${j}`)))))), /* @__PURE__ */ import_react4.default.createElement("label", null, "Edit mode ", /* @__PURE__ */ import_react4.default.createElement("input", {
      type: "checkbox",
      checked: editMode,
  ...
  Crossword.propTypes = {
    colSize: import_prop_types2.default.number,
    gridSize: import_prop_types2.default.number,
    cellSize: import_prop_types2.default.number
  };
